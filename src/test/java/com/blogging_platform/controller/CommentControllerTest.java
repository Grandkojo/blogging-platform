...
class CommentControllerTest {
    ...
    void getComments_rest_returnsPagedComments() {
        ...
        ResponseEntity<ApiResponse<Object>> response = controller.getComments(0, 10, "datetime", "DESC");
    ...
    void createComment_rest_callsServiceAndReturnsCreated() {
        ...
        ResponseEntity<ApiResponse<Object>> response = controller.createComment(userId, postId, comment);
        ...
        assertEquals(UUID.fromString(userId), comment.getUserId());
        assertEquals(UUID.fromString(postId), comment.getPostId());
    }
    ...
    void editComment_rest_callsServiceAndReturnsUpdated() {
        ...
        ResponseEntity<ApiResponse<Object>> response = controller.editComment(id, userId, comment);
...
// assertEquals(HttpStatus.OK.value(), response.getBody().getStatus());
// assertEquals("Comments Fetched Successfully",
...
// @Test
// void getComment_rest_returnsSingleComment() {
// CommentRecord record = new CommentRecord("c1", "p1", "u1", "Author", "Nice",
// null);
...
// controller.getPostComments("p1");

// assertEquals(HttpStatus.OK.value(), response.getBody().getStatus());
// assertEquals("Post Comments Found Successfully",
// response.getBody().getMessage());
// assertEquals(records, response.getBody().getData());
...
// ResponseEntity<ApiResponse<Object>> response = controller.editPost("c1",
// comment);

// verify(commentService).editComment(comment);
// assertEquals(HttpStatus.CREATED.value(), response.getBody().getStatus());
// assertEquals("Comment Updated Successfully",
// response.getBody().getMessage());
// }

// @Test
// void deleteComment_rest_callsServiceAndReturnsAccepted() {
// ResponseEntity<ApiResponse<Object>> response = controller.deletePost("u1",
// "c1");
